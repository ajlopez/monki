...
pdef.define('command', [ 'keyword:if', 'delimiter:(', 'expression', 'delimiter:)', 'command' ], function (values) { return geast.conditional(values[2], values[4]); });
...
pdef.define('command', [ 'keyword:let', 'lefthand', 'operator:=', 'expression', 'delimiter:;' ], function (values) { return geast.assign(values[1], values[3]); });
...
pdef.define('cmdlist', [ 'expression', '!', 'delimiter:}' ], function (values) { return [ geast.eval(values[0]) ]; });
...
pdef.define('function', [ 'keyword:fn', 'delimiter:(', 'arglist', 'delimiter:)', 'command' ], function (values) { return geast.function(values[2], values[4]); });
...
pdef.define('boolean', 'keyword:true', function (value) { return geast.constant(true); });
pdef.define('boolean', 'keyword:false', function (value) { return geast.constant(false); });

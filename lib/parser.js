...
pdef.define('cmdlist', [ 'command', 'delimiter:}' ], function (values) { return [values[0]]; });
pdef.define('cmdlist', [ 'command', 'cmdlist', 'delimiter:}' ], function (values) { values[1].unshift(values[0]); return values[1]; });
